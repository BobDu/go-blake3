...
//go:noinline
func pad0(x uint32) uint32 { return x*3 + 7 }

//go:noinline
func pad1(x uint32) uint32 { return x*5 + 8 }

//go:noinline
func pad2(x uint32) uint32 { return x*7 + 9 }

//go:noinline
func pad3(x uint32) uint32 { return x*9 + 10 }

//go:noinline
func pad4(x uint32) uint32 { return x*11 + 11 }

//go:noinline
func pad5(x uint32) uint32 { return x*13 + 12 }

//go:noinline
func pad6(x uint32) uint32 { return x*15 + 13 }

//go:noinline
func pad7(x uint32) uint32 { return x*17 + 14 }

//go:noinline
func pad8(x uint32) uint32 { return x*19 + 15 }

var PadSink uint32

func init() {
	PadSink = pad0(PadSink) + pad1(PadSink) + pad2(PadSink) + pad3(PadSink) + pad4(PadSink) + pad5(PadSink) + pad6(PadSink) + pad7(PadSink) + pad8(PadSink)
}

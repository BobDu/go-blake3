...
func HashF(c Ctx) {
	...
	const (
		arenaMsg       = 0
		arenaSpills    = arenaMsg + 16*64
		arenaYmmSpills = arenaSpills + 16*roundSize
...

	{
		...
		loadCounter(c, ymmAlloc, counter_mem, ctr_lo_mem, ctr_hi_mem)
	}
...

	{
		...
		transposeMsg(c, ymmAlloc, loop, input, msg)
	}
